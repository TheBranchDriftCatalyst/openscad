...
- lots of stuff to do but, basic command is now working
  ...
  - [x] fix issue with jinja filters not avaliable, pita
  - [~] need to still add the ability to run from outside the project directoryß
...
- [x] extract into git submodule, self repo